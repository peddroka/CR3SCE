...
// Lista das tabelas que armazenam dados pessoais ou conteúdo do usuário.
// São consultadas com RLS (o usuário logado só vê as próprias linhas).
...
export async function GET(request: Request) {
  ...
  for (const table of USER_DATA_TABLES) {
    ...
    if (error) {
      // Tabela pode não existir ainda — registramos e seguimos.
