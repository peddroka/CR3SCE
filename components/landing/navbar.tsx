...
export function Navbar() {
  ...
  return (
    ...
    >
        ...
        <div className="hidden items-center gap-10 md:flex">
          {navItems.map((item) => (
            ...
            >
              ...
              <span
                className={cn(
                  "absolute -bottom-1 left-0 right-0 h-0.5 rounded-full bg-lime transition-all duration-300",
      ...
      <div
        className={cn(
          "overflow-hidden border-b border-border bg-card px-6 transition-all duration-300 ease-in-out md:hidden",
          isOpen ? "max-h-[500px] opacity-100 pb-4" : "max-h-0 opacity-0 border-b-0",
        )}
      >
